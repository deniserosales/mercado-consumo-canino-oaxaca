...
; Concentración de Valor (Ley de Potencia): El segmento "Estrella" (Precio > $319 MXN + Alto Volumen) 
; es el motor del mercado, generando más del 90% de los ingresos totales, superando masivamente a las estrategias de 
; bajo costo.

; Techo del Mercado Masivo: Existe una barrera psicológica de precio en los $1,300 MXN. 
...
; Polarización de Categorías: Mientras que Accesorios domina en cantidad de oferta (mercado saturado),
